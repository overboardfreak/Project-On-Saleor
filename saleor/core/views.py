...
def stores(request):
    return TemplateResponse(request,'stores.html')
def belly(request):
    return TemplateResponse(request,'belly.html')
def brownie(request):
    return TemplateResponse(request,'brownie.html')
def spoonful(request):
    return TemplateResponse(request,'spoonful.html')
def glen(request):
    return TemplateResponse(request,'glen.html')
